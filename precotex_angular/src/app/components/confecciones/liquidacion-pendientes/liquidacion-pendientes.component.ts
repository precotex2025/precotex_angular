...
@Component({
  selector: 'app-liquidacion-pendientes',
  templateUrl: './liquidacion-pendientes.component.html',
  styleUrls: ['./liquidacion-pendientes.component.scss']
})
export class LiquidacionPendientesComponent implements OnInit {
