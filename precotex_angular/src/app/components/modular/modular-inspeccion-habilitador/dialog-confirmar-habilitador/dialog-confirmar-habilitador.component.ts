...
@Component({
  selector: 'app-dialog-confirmar-habilitador',
  templateUrl: './dialog-confirmar-habilitador.component.html',
  styleUrls: ['./dialog-confirmar-habilitador.component.scss']
})
export class DialogConfirmarHabilitadorComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
    ...
    private dialogRef: MatDialogRef<DialogConfirmarHabilitadorComponent>,
