...
@Component({
  selector: 'app-dialig-defectos-auditoria',
  templateUrl: './dialig-defectos-auditoria.component.html',
  styleUrls: ['./dialig-defectos-auditoria.component.scss']
})
export class DialigDefectosAuditoriaComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<DialigDefectosAuditoriaComponent>,
    private formBuilder: FormBuilder,
    private matSnackBar: MatSnackBar,
    private SpinnerService: NgxSpinnerService,
    private auditoriaPrendaService: AuditoriaPrendaService,
  ...
  selectMedida(Abr_Motivo: string) {
    if (this.Total == 0) {
      ...
      this.auditoriaPrendaService.CF_Man_Modular_Auditoria_Detalle_Web(
        'I',
        this.data.Id_N,
  ...
  MostrarDefectoPorTipo() {
    ...
    this.auditoriaPrendaService.CF_MODULAR_AUDITORIA_DEFECTO_FAMILIA(
      this.Id,
      this.Cod_Familia
    ).subscribe(
      (result: any) => {
