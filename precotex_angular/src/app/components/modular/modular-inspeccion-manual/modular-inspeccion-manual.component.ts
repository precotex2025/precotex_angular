...
import { DialogDefectosRecuperacionComponent } from '../modular-inspeccion-recuperacion/dialog-defectos-recuperacion/dialog-defectos-recuperacion.component';
...
@Component({
  selector: 'app-modular-inspeccion-manual',
  templateUrl: './modular-inspeccion-manual.component.html',
  styleUrls: ['./modular-inspeccion-manual.component.scss']
})
export class ModularInspeccionManualComponent implements OnInit {
  ...
  Min_Asistidos = 0
  Eficiencia = 0
  constructor(private formBuilder: FormBuilder, private matSnackBar: MatSnackBar, private SpinnerService: NgxSpinnerService, private inspeccionSegundaService: InspeccionSegundaService, public dialog: MatDialog, private inspeccionPrendaService: InspeccionPrendaService) { }
  ...
  GuardarCabecera() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result == 'true') {
        ...
        this.inspeccionSegundaService.CF_Modular_Inspeccion_Prenda_Man_Web(
          this.Cod_Accion,
          this.Cod_Fabrica,
          this.Cod_OrdPro,
          this.Cod_Present,
  ...
  agregarPrenda() {
    this.SpinnerService.show();
    this.inspeccionSegundaService.CF_Modular_Agregar_Prenda_Man_Web(
      'I',
      this.Id,
      '0',
      GlobalVariable.vusu
  ...
  finalizarAuditoria(Flg_Estado){
    this.SpinnerService.show();
    if (confirm('¿Esta seguro(a) de finalizar la inspección?')) {
      this.inspeccionSegundaService.CF_Man_Modular_Auditoria_Finaliza_Web(
        'I',
        Flg_Estado,
        this.Id,
        0,
