...
import { DialogConfirmarHabilitadorComponent } from '../modular-inspeccion-habilitador/dialog-confirmar-habilitador/dialog-confirmar-habilitador.component';
...
@Component({
  selector: 'app-modal-recuperacion-recojo',
  templateUrl: './modal-recuperacion-recojo.component.html',
  styleUrls: ['./modal-recuperacion-recojo.component.scss']
})
export class ModalRecuperacionRecojoComponent implements OnInit {
