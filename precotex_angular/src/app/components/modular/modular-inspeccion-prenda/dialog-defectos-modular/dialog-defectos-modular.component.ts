...
@Component({
  selector: 'app-dialog-defectos-modular',
  templateUrl: './dialog-defectos-modular.component.html',
  styleUrls: ['./dialog-defectos-modular.component.scss']
})
export class DialogDefectosModularComponent implements OnInit {
  Id = 0
  Cod_Familia = ""
  Total = 0
  ...
  constructor(public dialogRef: MatDialogRef<DialogDefectosModularComponent>,
  ...
  MostrarDefectoPorTipo() {
    ...
    this.inspeccionPrendaService.CF_MODULAR_INSPECCION_DEFECTO_FAMILIA(
      this.Id,
      this.Cod_Familia
    ).subscribe(
      (result: any) => {
