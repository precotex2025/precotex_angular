...
@Component({
  selector: 'app-dialog-hoja-ingenieria-operacion-crear',
  templateUrl: './dialog-hoja-ingenieria-operacion-crear.component.html',
  styleUrls: ['./dialog-hoja-ingenieria-operacion-crear.component.scss']
})

export class DialogHojaIngenieriaOperacionCrearComponent implements OnInit {
  ...
  constructor(
    ...
    public dialog_: MatDialogRef<DialogHojaIngenieriaOperacionCrearComponent>,
  ...
  ngOnInit(): void { 
    ...
    this.formulario.controls['sDesEstPro'].disable()
  ...
  RegistrarHoja() {
    if (this.formulario.valid) {
      ...
      let TipoTela = this.formulario.get('sTipoTela').value
  ...
  definirTitulo(){
    ...
    if(this.data.Num_Hoja_Correlativo == undefined){//Boton nuevo pulsado
     ...
     this.Titulo    = 'Modificar Hoja de Ingenieria ' + this.data.Num_Hoja_Correlativo
  ...
  addPasoOperacion(){
    ...
    let sNumOrden = this.formulario.get('sNumOrden').value
    ...
    if(sTitulo!='' && sDescripcion!=''){
      ...
      this.formulario.controls['sNumOrden'].setValue('')
  ...
  updatePasoOperacion(){
    ...
    if (paso) {
      ...
      paso.Orden = this.formulario.get('sNumOrden').value
