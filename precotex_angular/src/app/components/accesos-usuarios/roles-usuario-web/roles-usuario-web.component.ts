...
import { DialogCrearRolWebComponent } from './dialog-crear-rol-web/dialog-crear-rol-web.component';
...
@Component({
  selector: 'app-roles-usuario-web',
  templateUrl: './roles-usuario-web.component.html',
  styleUrls: ['./roles-usuario-web.component.scss']
})
export class RolesUsuarioWebComponent implements OnInit {
