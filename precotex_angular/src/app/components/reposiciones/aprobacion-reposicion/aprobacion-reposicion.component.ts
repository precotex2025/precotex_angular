...
import { DialogAprobacionReposicionComponent } from './dialog-aprobacion-reposicion/dialog-aprobacion-reposicion.component';
...
@Component({
  selector: 'app-aprobacion-reposicion',
  templateUrl: './aprobacion-reposicion.component.html',
  styleUrls: ['./aprobacion-reposicion.component.scss']
})
export class AprobacionReposicionComponent implements OnInit {
  ...
  obtenerReposiciones() {
    ...
    this.reposicionesService.getReposiciones('L', '', this.range.get('start').value, this.range.get('end').value, this.Estado, 'C').subscribe(
      (result: any) => {
        console.log(result);
        if (result != false) {
  ...
  changeAprobacion(event, Num_Solicitud) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      console.log(result);
      if (result != '') {
        this.reposicionesService.saveAprobReposiciones('O', Num_Solicitud, result['observaciones'], result.estado).subscribe(
          (res: any) => {
            console.log(res);
