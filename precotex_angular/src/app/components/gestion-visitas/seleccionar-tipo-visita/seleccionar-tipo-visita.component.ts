...
@Component({
  selector: 'app-seleccionar-tipo-visita',
  templateUrl: './seleccionar-tipo-visita.component.html',
  styleUrls: ['./seleccionar-tipo-visita.component.scss']
})
export class SeleccionarTipoVisitaComponent implements OnInit {
