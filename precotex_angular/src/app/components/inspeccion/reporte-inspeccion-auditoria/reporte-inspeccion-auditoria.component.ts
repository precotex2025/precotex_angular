...
@Component({
  selector: 'app-reporte-inspeccion-auditoria',
  templateUrl: './reporte-inspeccion-auditoria.component.html',
  styleUrls: ['./reporte-inspeccion-auditoria.component.scss']
})
export class ReporteInspeccionAuditoriaComponent implements OnInit {
  ...
  generateExcel() {
    ...
    if (this.dataSource.data.length == 0) {
      ...
      let reportData = {
        title: 'REPORTE DE INSPECCIÓN DE AUDITORIA',
