...
@Component({
  selector: 'app-inspeccion-liberacion-paquete',
  templateUrl: './inspeccion-liberacion-paquete.component.html',
  styleUrls: ['./inspeccion-liberacion-paquete.component.scss']
})
export class InspeccionLiberacionPaqueteComponent implements OnInit {
  ...
  MostrarCabeceraPaquetes() {
    ...
    this.seguridadControlVehiculoService.mantenimientoInspeccionService(
      this.ticket,
      this.usuario
    ).subscribe(
      (result: any) => {
