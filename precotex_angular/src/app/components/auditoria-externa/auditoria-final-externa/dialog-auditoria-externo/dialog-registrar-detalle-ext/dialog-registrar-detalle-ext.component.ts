...
@Component({
  selector: 'app-dialog-registrar-detalle-ext',
  templateUrl: './dialog-registrar-detalle-ext.component.html',
  styleUrls: ['./dialog-registrar-detalle-ext.component.scss']
})
export class DialogRegistrarDetalleExtComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   if(this.Titulo != undefined){
    ...
    if(this.data.Flg_Reproceso_Num>0){
...
/* --------------- REGISTRAR CABECERA ------------------------------------------ */
  ...
  submit(formDirective) :void {
    ...
    this.Num_Auditoria         = this.data.Num_Auditoria
    this.Cod_Inspector         = GlobalVariable.vtiptra + '-' + GlobalVariable.vcodtra
