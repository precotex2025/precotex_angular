...
@Component({
  selector: 'app-dialog-sub-detalle-externo',
  templateUrl: './dialog-sub-detalle-externo.component.html',
  styleUrls: ['./dialog-sub-detalle-externo.component.scss']
})
export class DialogSubDetalleExternoComponent implements OnInit {
  public data_det = [{
 ...
 // nuevas variables
  ...
  ModificarSubDetalle(Cod_Motivo: string, Descripcion: string, Cantidad: number) {
    ...
    let dialogRef = this.dialog.open(DialogRegistrarSubdetalleExtComponent, {
      disableClose: true,
