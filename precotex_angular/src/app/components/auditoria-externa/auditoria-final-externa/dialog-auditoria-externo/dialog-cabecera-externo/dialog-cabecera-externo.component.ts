...
@Component({
  selector: 'app-dialog-cabecera-externo',
  templateUrl: './dialog-cabecera-externo.component.html',
  styleUrls: ['./dialog-cabecera-externo.component.scss']
})
export class DialogCabeceraExternoComponent implements OnInit {
