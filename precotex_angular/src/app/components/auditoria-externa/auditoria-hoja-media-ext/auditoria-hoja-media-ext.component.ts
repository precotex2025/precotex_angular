...
import { DialogObservacionHojaMedidaComponent } from '../../auditoria-calidad/auditoria-hoja-medida/dialog-auditoria-hoja-medida/dialog-observacion-hoja-medida/dialog-observacion-hoja-medida.component';
...
@Component({
  selector: 'app-auditoria-hoja-media-ext',
  templateUrl: './auditoria-hoja-media-ext.component.html',
  styleUrls: ['./auditoria-hoja-media-ext.component.scss']
})
export class AuditoriaHojaMediaExtComponent implements OnInit {
  ...
  generateExcel(data_det: data_det) {
    ...
    this.auditoriaHojaMedidaService.AuditoriaHojaMedidaCargaMedidaService(
      ...
      (result: any) => {
        ...
        let reportData = {
          title: 'REPORTE REGISTRO HOJA DE MEDIDA - COSTURA Nº' + data_det.Cod_Hoja_Medida_Cab,
