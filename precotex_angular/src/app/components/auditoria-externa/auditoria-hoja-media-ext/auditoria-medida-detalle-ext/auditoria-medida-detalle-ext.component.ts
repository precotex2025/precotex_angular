...
import { DialogRegistroHojaMedidaComponent } from 'src/app/components/auditoria-calidad/auditoria-hoja-medida/dialog-auditoria-hoja-medida/dialog-registro-hoja-medida/dialog-registro-hoja-medida.component';
...
@Component({
  selector: 'app-auditoria-medida-detalle-ext',
  templateUrl: './auditoria-medida-detalle-ext.component.html',
  styleUrls: ['./auditoria-medida-detalle-ext.component.scss']
})
export class AuditoriaMedidaDetalleExtComponent implements OnInit {
  ...
  BuscarLinea() {
    this.auditoriaHojaMedidaService.BuscarLineaExtService().subscribe(
      (result: any) => {
        //console.log(result)
  ...
  verificarEstadoFicha() {
    ...
    this.auditoriaHojaMedidaService.MantenimientoAuditoriaHojaMedidaCabeceraExt(
      this.Cod_Accion,
      this.Cod_Hoja_Medida_Cab,
      this.Cod_OrdPro,
      this.Cod_ColCli,
