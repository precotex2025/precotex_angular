...
@Component({
  selector: 'app-seguridad-control-jabas-interno',
  templateUrl: './seguridad-control-jabas-interno.component.html',
  styleUrls: ['./seguridad-control-jabas-interno.component.scss']
})
export class SeguridadControlJabasInternoComponent implements OnInit, AfterViewInit  {
  ...
  ListarGuia() {
    this.segurdadControlJabaService.ListarGuiaInternoService(GlobalVariable.num_planta).subscribe(
      (result: any) => {
        console.log(result)
