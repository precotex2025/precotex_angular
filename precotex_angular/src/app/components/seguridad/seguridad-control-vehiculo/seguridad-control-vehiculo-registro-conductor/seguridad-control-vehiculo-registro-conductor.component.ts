...
import { DialogVehiculoRegistrarComponent } from '../dialog-vehiculo/dialog-vehiculo-registrar/dialog-vehiculo-registrar.component';
...
import { DialogDerivadosModificarComponent } from 'src/app/components/auditoria-calidad/defectos-almacen-derivados/dialog-almacen-derivado/dialog-derivados-modificar/dialog-derivados-modificar.component';
...
@Component({
  selector: 'app-seguridad-control-vehiculo-registro-conductor',
  templateUrl: './seguridad-control-vehiculo-registro-conductor.component.html',
  styleUrls: ['./seguridad-control-vehiculo-registro-conductor.component.scss']
})


export class SeguridadControlVehiculoRegistroConductorComponent implements OnInit {
  ...
  openDialog() {
    ...
    let dialogRef = this.dialog.open(DialogVehiculoRegistrarComponent, {
      disableClose: true,
      data: {}
    });
  ...
  openDialogModificar( Cod_Conductor: string, Nro_DocIde: string) {
    ...
    let dialogRef = this.dialog.open(DialogVehiculoRegistrarComponent, {
      disableClose: true,
      data: {Cod_Conductor: Cod_Conductor, Nro_DocIde: Nro_DocIde}
    });
  ...
  AsignarNumAuditoriaModificar(Nro_DocIde: string, Cod_Conductor: string) {
    this.Codigo_Conductor_a_Modificar = Cod_Conductor
    console.log(this.Codigo_Conductor_a_Modificar)
    ...
    let dialogRef = this.dialog.open(DialogDerivadosModificarComponent, {
      ...
      height: '100%',
      width: '100%',
      data: this.Codigo_Conductor_a_Modificar
    });
    dialogRef.afterClosed().subscribe(result => {
