...
@Component({
  selector: 'app-dialog-ingreso-empleadorefrigerio',
  templateUrl: './dialog-ingreso-empleadorefrigerio.component.html',
  styleUrls: ['./dialog-ingreso-empleadorefrigerio.component.scss']
})
export class DialogIngresoEmpleadorefrigerioComponent implements OnInit {
  ...
  changeHoraInicio(event){
    ...
    if(minutos < -30){
      ...
      this.formulario.get('horafinal')?.setValue(endTime);
    }
