...
@Component({
  selector: 'app-dialog-auditoria-hoja-molde-medidas',
  templateUrl: './dialog-auditoria-hoja-molde-medidas.component.html',
  styleUrls: ['./dialog-auditoria-hoja-molde-medidas.component.scss']
})
export class DialogAuditoriaHojaMoldeMedidasComponent implements OnInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogAuditoriaHojaMoldeMedidasComponent>,
  ...
  selectMedida(medida: string){
    ...
    if(medida == '-'){
      ...
      this.dialogRef.close({data:medida, estado:"1"});
      this.Menos = '';
    }
  }
