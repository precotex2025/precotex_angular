...
@Component({
  selector: 'app-dialog-registrar-modulo-defectos',
  templateUrl: './dialog-registrar-modulo-defectos.component.html',
  styleUrls: ['./dialog-registrar-modulo-defectos.component.scss']
})
export class DialogRegistrarModuloDefectosComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
              ...
              private dialogRef: MatDialogRef<DialogRegistrarModuloDefectosComponent>) 
  {
