...
@Component({
  selector: 'app-dialog-cabecera-modulo-acabado',
  templateUrl: './dialog-cabecera-modulo-acabado.component.html',
  styleUrls: ['./dialog-cabecera-modulo-acabado.component.scss']
})
export class DialogCabeceraModuloAcabadoComponent implements OnInit {
  ...
  this.CargarModulo();
   ...
   if(this.Titulo != undefined){
    let arr = this.data.Cod_Modulo.split('-');
      ...
      this.formulario.controls['Modulo'].setValue(arr[0])
  ...
  CargarModulo() {
    this.auditoriaAcabadosService.CargarModulos().subscribe(
      (result: any) => {
        //console.log(result)
