...
import { DialogRegistrarModuloDefectosComponent } from '../dialog-registrar-modulo-defectos/dialog-registrar-modulo-defectos.component';
interface data{
...
@Component({
  selector: 'app-dialog-modulo-defectos',
  templateUrl: './dialog-modulo-defectos.component.html',
  styleUrls: ['./dialog-modulo-defectos.component.scss']
})
export class DialogModuloDefectosComponent implements OnInit {
  public data_det = [{
 ...
 // nuevas variables
  ...
  displayedColumns_cab: string[] = ['Num_Auditoria_Defecto', 'Cod_Motivo', 'Descripcion', 'Cantidad', 'Acciones']
  ...
  MostrarSubDetalleAuditoria() {
    ...
    this.Cod_Motivo                 = ''
    this.Cantidad                   = 0
    this.auditoriaAcabadosService.Mant_AuditoriaModuloAcabadoDefectosDetService(
      this.Cod_Accion,
  ...
  ModificarSubDetalle(Cod_Motivo: string, Descripcion: string, Cantidad: number) {
    ...
    let dialogRef = this.dialog.open(DialogRegistrarModuloDefectosComponent, {
      disableClose: true,
