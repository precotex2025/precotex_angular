...
@Component({
  selector: 'app-vista-previa-modulo-defectos',
  templateUrl: './vista-previa-modulo-defectos.component.html',
  styleUrls: ['./vista-previa-modulo-defectos.component.scss']
})
export class VistaPreviaModuloDefectosComponent implements OnInit {
  ...
  private dialogRef: MatDialogRef<VistaPreviaModuloDefectosComponent>,
