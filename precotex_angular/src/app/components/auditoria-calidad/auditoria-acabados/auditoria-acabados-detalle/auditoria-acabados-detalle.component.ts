...
import { DialogRegistroAcabadosMedidaComponent } from '../../auditoria-acabados/dialog-auditoria-acabados-medida/dialog-registro-acabados-medida/dialog-registro-acabados-medida.component';
...
@Component({
  selector: 'app-auditoria-acabados-detalle',
  templateUrl: './auditoria-acabados-detalle.component.html',
  styleUrls: ['./auditoria-acabados-detalle.component.scss']
})
export class AuditoriaAcabadosDetalleComponent implements OnInit {
  ...
  verificarEstadoFicha() {
    ...
    this.auditoriaHojaMedidaService.MantenimientoAuditoriaHojaMedidaAcabadosCabecera(
      this.Cod_Accion,
      this.Cod_Hoja_Medida_Cab,
      this.Cod_OrdPro,
      this.Cod_ColCli,
    ...
    this.auditoriaHojaMedidaService.MantenimientoAuditoriaHojaMedidaAcabadosCabecera(
      ...
      (result: any) => {
        if (result.length > 0) { 
          ...
          this.formulario.controls['Tipo'].setValue(parseInt(result[0].Tipo));
  ...
  buscarPorOp() {
    ...
    if (this.Cod_OrdPro.length == 5) {
      this.Cod_Accion = '1'
      this.Cod_OrdPro
      this.auditoriaHojaMedidaService.AuditoriaHojaMedidaPrendaAcabadosService(
        this.Cod_Accion,
        this.Cod_OrdPro
      ).subscribe(
        (result: any) => {
          ...
          if (result.length > 0) {
            ...
            this.formulario.controls['Linea'].setValue(result[0].Linea)
  ...
  onCellClicked(e: CellClickedEvent, params): void {
    ...
    if (this.Flg_Enable == true) {
      if (ultimoCaracter == '1' || ultimoCaracter == '2' || ultimoCaracter == '3' || ultimoCaracter == '4' || ultimoCaracter == '5') {
        ...
        let dialogRef = this.dialog.open(DialogRegistroAcabadosMedidaComponent,
          {
            disableClose: true,
            panelClass: 'my-class',
            data: {
  ...
  MostrarCargaMedida() {
    ...
    this.Cod_Hoja_Medida_Cab
    this.auditoriaHojaMedidaService.AuditoriaHojaMedidaCargaMedidaAcabadosService(
      this.Cod_EstPro,
      this.Cod_Version,
  ...
  submit(formDirective): void {
    ...
    this.Flg_Estado = 'P',
      this.Fecha_Auditoria = ''
    this.Fecha_Auditoria2 = ''
    this.auditoriaAcabadosService.MantenimientoAuditoriaAcabadosCabecera(
      this.Cod_Accion,
      this.Cod_Hoja_Medida_Cab,
      this.Cod_OrdPro,
      this.Cod_ColCli,
      ...
      if (result == 'true') {
        ...
        this.auditoriaHojaMedidaService.MantenimientoAuditoriaHojaMedidaAcabadosCabecera(
          ...
          (result: any) => {
            ...
            if (result[0].Respuesta == 'OK') {
              this.router.navigate(['/AuditoriaAcabados']);
  ...
  CargarOperacionMedida() {
    ...
    this.Medida1 = ''
    this.Medida2 = ''
    this.auditoriaHojaMedidaService.MantenimientoAuditoriaHojaMedidaAcabadosDetalle(
      this.Cod_Accion,
      this.Cod_Hoja_Medida_Det,
      this.Cod_Hoja_Medida_Cab,
      this.Sec,
