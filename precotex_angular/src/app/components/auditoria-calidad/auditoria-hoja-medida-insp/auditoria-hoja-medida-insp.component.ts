...
import { DialogObservacionHojaMedidaInspComponent } from './dialog-observacion-hoja-medida-insp/dialog-observacion-hoja-medida-insp.component';
...
interface data_det {
  ...
  Cod_OrdPro_Ref: string
  Cod_EstCli_Ref: string
}
...
@Component({
  selector: 'app-auditoria-hoja-medida-insp',
  templateUrl: './auditoria-hoja-medida-insp.component.html',
  styleUrls: ['./auditoria-hoja-medida-insp.component.scss']
})
export class AuditoriaHojaMedidaInspComponent implements OnInit {
  ...
  displayedColumns_cab: string[] = ['Cod_Hoja_Medida_Cab', 'Cod_OrdPro', 'Cod_TemCli', 'Cod_ColCli', 'Cod_LinPro', 'Auditor', 'Fecha_Registro', 'Flg_Estado', 'Observacion', 'Acciones']
  ...
  actualizarObservacion(Cod_Hoja_Medida_Cab: number, Observacion: string) {
    console.log(Observacion)
    let dialogRef = this.dialog.open(DialogObservacionHojaMedidaInspComponent,
      {
        disableClose: true,
        panelClass: 'my-class',
        data: {
          Cod_Hoja_Medida_Cab: Cod_Hoja_Medida_Cab,
  ...
  generateExcel(data_det: data_det) {
    ...
    this.auditoriaHojaMedidaService.AuditoriaHojaMedidaCargaMedidaServiceInsp(
      ...
      (result: any) => {
        ...
        let reportData = {
          title: 'REPORTE REGISTRO HOJA DE MEDIDA - INSPECCION Nº' + data_det.Cod_Hoja_Medida_Cab,
          ...
          Cod_Verion: data_det.Cod_Version,
          Cod_OrdPro: data_det.Cod_OrdPro,
          Auditor: data_det.Auditor,
          Cod_OrdPro_Ref: data_det.Cod_OrdPro_Ref,
          Cod_EstCli_Ref: data_det.Cod_EstCli_Ref,
