...
@Component({
  selector: 'app-dialog-registro-hoja-medida-insp',
  templateUrl: './dialog-registro-hoja-medida-insp.component.html',
  styleUrls: ['./dialog-registro-hoja-medida-insp.component.scss']
})
export class DialogRegistroHojaMedidaInspComponent implements OnInit {
 ...
 constructor(public dialogRef: MatDialogRef<DialogRegistroHojaMedidaInspComponent>,
