...
@Component({
  selector: 'app-dialog-observacion-hoja-medida-insp',
  templateUrl: './dialog-observacion-hoja-medida-insp.component.html',
  styleUrls: ['./dialog-observacion-hoja-medida-insp.component.scss']
})
export class DialogObservacionHojaMedidaInspComponent implements OnInit {
  ...
  ngOnInit(): void {
    console.log(this.data.Observacion)
