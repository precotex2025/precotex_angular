...
import { DialogRegistrarVaporizadoDefectosComponent } from '../dialog-registrar-vaporizado-defectos/dialog-registrar-vaporizado-defectos.component'
...
@Component({
  selector: 'app-dialog-vaporizado-defectos',
  templateUrl: './dialog-vaporizado-defectos.component.html',
  styleUrls: ['./dialog-vaporizado-defectos.component.scss']
})
export class DialogVaporizadoDefectosComponent implements OnInit {
  ...
  ModificarSubDetalle(Cod_Motivo: string, Descripcion: string, Cantidad: number) {
    ...
    let dialogRef = this.dialog.open(DialogRegistrarVaporizadoDefectosComponent, {
      disableClose: true,
