...
@Component({
  selector: 'app-control-merma',
  templateUrl: './control-merma.component.html',
  styleUrls: ['./control-merma.component.scss']
})
export class ControlMermaComponent implements OnInit {
  fecha: string = '';
  ...
  editarOpcion(data) {
    ...
    this._router.navigate(['ActualizarControlMerma'], { skipLocationChange: true, queryParams: parametros });
  }
