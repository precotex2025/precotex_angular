...
import { VistaPreviaChecklistDefectosComponent } from '../vista-previa-checklist-defectos/vista-previa-checklist-defectos.component';
import { DialogRegistrarDetalleChecklistComponent } from '../dialog-registrar-detalle-checklist/dialog-registrar-detalle-checklist.component';
import { DialogChecklistDefectosCosturaComponent } from '../dialog-checklist-defectos-costura/dialog-checklist-defectos-costura.component';
import { DialogRegistrarDatosIngresoComponent } from '../dialog-registrar-datos-ingreso/dialog-registrar-datos-ingreso.component';
interface data{
  Cod_LinPro:    string
...
@Component({
  selector: 'app-dialog-detalle-checklist-costura',
  templateUrl: './dialog-detalle-checklist-costura.component.html',
  styleUrls: ['./dialog-detalle-checklist-costura.component.scss']
})
export class DialogDetalleChecklistCosturaComponent implements OnInit {
 ...
 // nuevas variables
  ...
  displayedColumns_cab: string[] = ['Num_Auditoria_Detalle','Nom_Inspector','Cod_OrdCor', 'Cod_OrdPro', 'Nom_Cliente', 'Cod_EstCli', 'Cod_Present', 'Can_Lote', 'Can_Muestra', 'Can_Defecto', 'Flg_Status', 'Acciones']
  ...
  ModificarRegistroDetalle(Num_Auditoria_Detalle: number, Cod_Inspector: string, Nom_Auditor: string, Cod_OrdPro: string, Cod_Cliente: string, Des_Cliente: string, Cod_EstCli: string, Des_EstPro: string,Cod_Present: string, Des_Present: string, Can_Lote: number, Can_Muestra: number, Observacion: string, Flg_Status: string, Flg_Reproceso_Num: number, Cod_OrdCor: string) {
 
    let dialogRef = this.dialog.open(DialogRegistrarDetalleChecklistComponent, {
      disableClose: true,
  ...
  openDialogSubDetalle(Num_Auditoria_Detalle: number, Flg_Status: string){
    ...
    if(Flg_Status != 'R' || this.ll_Supervisor){
      let dialogRef = this.dialog.open(DialogChecklistDefectosCosturaComponent, {
        disableClose: true,
  ...
  ReprocesoRegistroDetalle(Num_Auditoria_Detalle: number, Cod_Inspector: string, Nom_Auditor: string, Cod_OrdPro: string, Cod_Cliente: string, Des_Cliente: string, Cod_EstCli: string, Des_EstPro: string,Cod_Present: string, Des_Present: string, Can_Lote: number, Can_Muestra: number,Co_CodOrdPro: string, Num_Paquete: string, Observacion: string, Cod_OrdCor: string){
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result == 'true') {
        ...
        formData.append('Can_Lote', Can_Lote.toString()); 			
  ...
  vistaPreviaAuditoria(data_det: data_det) {
    ...
    let dialogRef = this.dialog.open(VistaPreviaChecklistDefectosComponent, {
      disableClose: true,
      panelClass: 'my-class',
      maxWidth: '95vw',
      maxHeight: '98vh',
  ...
  datosAdicionales(Num_Auditoria_Detalle: number, Cod_Inspector: string, Nom_Auditor: string, Cod_OrdPro: string, Cod_Cliente: string, Des_Cliente: string, Cod_EstCli: string, Des_EstPro: string,Cod_Present: string, Des_Present: string, Can_Lote: number, Can_Muestra: number, Observacion: string, Cod_LinPro: string, Medidas: string, Muestra_Fisica: string, Checklist: string) {
 
    let dialogRef = this.dialog.open(DialogRegistrarDatosIngresoComponent, {
      disableClose: true,
      data: { Num_Auditoria: this.data.Num_Auditoria,
              Num_Auditoria_Detalle: Num_Auditoria_Detalle,
              Cod_Inspector: Cod_Inspector,
