...
import { DialogRegistrarDefectosCosturaComponent } from '../dialog-registrar-defectos-costura/dialog-registrar-defectos-costura.component';
interface data{
...
@Component({
  selector: 'app-dialog-checklist-defectos-costura',
  templateUrl: './dialog-checklist-defectos-costura.component.html',
  styleUrls: ['./dialog-checklist-defectos-costura.component.scss']
})
export class DialogChecklistDefectosCosturaComponent implements OnInit {
  public data_det = [{
 ...
 // nuevas variables
  ...
  ModificarSubDetalle(Cod_Motivo: string, Descripcion: string, Cantidad: number) {
    ...
    let dialogRef = this.dialog.open(DialogRegistrarDefectosCosturaComponent, {
      disableClose: true,
