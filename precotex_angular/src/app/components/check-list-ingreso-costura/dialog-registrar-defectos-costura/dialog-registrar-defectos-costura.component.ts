...
@Component({
  selector: 'app-dialog-registrar-defectos-costura',
  templateUrl: './dialog-registrar-defectos-costura.component.html',
  styleUrls: ['./dialog-registrar-defectos-costura.component.scss']
})
export class DialogRegistrarDefectosCosturaComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder,
              ...
              private dialogRef: MatDialogRef<DialogRegistrarDefectosCosturaComponent>) 
  {
